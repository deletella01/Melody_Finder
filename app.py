...
data = pd.read_csv('~/Melody_Finder/dataset/data.csv')
genre_data = pd.read_csv('~/Melody_Finder/dataset/data_by_genres.csv')
year_data = pd.read_csv('~/Melody_Finder/dataset/data_by_year.csv')
...
def predict():
    ...
    return render_template('index.html', prediction_text='Similar Songs are: {}'.format(output))
